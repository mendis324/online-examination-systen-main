...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <!--    <li <?php if(@$_GET['q']==9) echo'class="active"'; ?>><a href="dash.php?q=0">Home<span class="sr-only">(current)</span></a></li>-->
...
if(@$_GET['q']== 2) {
  ...
  while($row=mysqli_fetch_array($q) ){
    $e=$row['email'];
    $s=$row['score'];
    $q12=mysqli_query($con,"SELECT * FROM users WHERE email='$e' AND role = 'user' " )or die('Error231');
...
$result = mysqli_query($con,"SELECT * FROM users WHERE role = 'user'") or die('Error');
echo  '<div class="panel"><div class="table-responsive"><table class="table table-striped title1">
<tr><td><b>S.N.</b></td><td><b>Name</b></td><td><b>College</b></td><td><b>Email</b></td><td><b>Mobile</b></td><td></td></tr>';
$c=1;
while($row = mysqli_fetch_array($result)) {
	$name = $row['name'];
	$mob = $row['mobile'];
